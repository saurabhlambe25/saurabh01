...
//			FileInputStream file=new  FileInputStream("F:\\Java Velocity\\1_Oct_Morning_Maven\\Propfile.properties");
//			
...
//		
		...
		public static String getdataFromExcelsheet(int RowIndex, int CellIndex) throws EncryptedDocumentException, IOException
		{
			//To reach upto Excelsheet
			  FileInputStream file=new  FileInputStream("F:\\Java Velocity\\Mavan_Practice\\Testdata\\1st_OCt_Practice.xlsx");  
...
//		                                                            //101
//		     File Destination=new File("F:\\Java Velocity\\1_Oct_Morning_Maven\\Screenshot."+TestCaseID+".jpg");
//		     
